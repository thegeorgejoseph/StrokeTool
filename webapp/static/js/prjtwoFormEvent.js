...
{
    var rTotal = 0;
    var selectedRealistic = document.forms["frm2Career"]["chkRealistictwo"];
    ...
    document.getElementById("lbl2Realistic").innerHTML = rTotal+ "/6 of the foods that can cause Diabetes selected."
